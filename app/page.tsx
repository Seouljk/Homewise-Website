...
export default function Home() {
  return <>
    ...
    <main id="main">
      ...
      <section className="about-section shell section" id="about" aria-labelledby="about-title" data-reveal><div className="about-logo"><Image src="/homewise-logo.png" alt="" width={82} height={86} /></div><span className="eyebrow">BUILT FOR THE BEGINNING</span><h2 id="about-title">Your next chapter.<br /><span>A little more considered.</span></h2><p>HomeWise helps homeowners, students, and early-stage planners explore the possibilities of a one-storey home in the Philippines.</p><a className="pill-button" href="#hero-title">Back to the beginning <ArrowRight size={18} aria-hidden="true" /></a><div className="scope-note"><HardHat size={20} aria-hidden="true" /><p>Start with an estimate. Build with a professional.<br /><span>HomeWise provides preliminary estimates for one-storey homes on flat sites with standard soil and wind assumptions. Review your plans, prices, and site requirements with qualified professionals before construction.</span></p></div></section>
    </main>
    <footer className="site-footer shell" data-reveal><div className="footer-brand"><Link href="/" aria-label="HomeWise home"><Image src="/homewise-wordmark.png" alt="HomeWise" width={156} height={52} /></Link><span>A wiser start to a place of your own.</span></div><nav aria-label="Footer navigation"><a href="#features">Features</a><a href="#how-it-works">How it works</a><a href="#about">About HomeWise</a></nav><div className="footer-bottom"><span>© {new Date().getFullYear()} HomeWise</span><span>Thoughtful planning. Better beginnings.</span></div></footer>
  </>;
}
